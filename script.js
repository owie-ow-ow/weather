...
var asOfText = document.getElementById('asOfText')
...
const hourlyWeatherBase = "https://api.msn.com/weather/hourlyforecast?apiKey=j5i4gDqHL6nGYwx5wi5kRhXjtf2c5qgFX9fzfk0TOo&appid=9e21380c-ff19-4c78-b4ea-19558e93a5d3&cm=en-US&locale=en&units=F&days=1"
var lat = undefined
var lon = undefined
...
async function getHourlyWeather(lat, lon) {
    ...
    var items = document.getElementsByClassName('hourlyItem'), len = items !== null ? items.length : 0, i = 0;
    ...
    current = json['value'][0]['responses'][0]['weather'][0]['days'][0]['hourly'].forEach(element => {
        ...
        var now = new Date().toLocaleString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true });

        asOfText.textContent = "Hourly weather as of " + now;
        ...
        tempText.classList.add('hourlyTemp')
        ...
        hourElement.classList.add('hourlyText')
        ...
        container.classList.add('hourlyItem')
